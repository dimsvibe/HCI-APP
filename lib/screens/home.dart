  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          ChangeThemeWidgetButton(),
          PopupMenuButton<String>(
            onSelected: handleClick,
            // TODO 1: add menu profile
            itemBuilder: (BuildContext context) {
              return {'Reset Passcode', 'Logout', 'Rate Application'}.map((String choice) {
...
class _ChatRoomListTileState extends State<ChatRoomListTile> {
  ...
  getThisUserInfo() async {
    ...
    print(
        "[DEBUG] ${querySnapshot.docs[0].id} - ${querySnapshot.docs[0].get("name")}");
